...
const isSpecialFormKeyword = (x: string): x is SpecialFormKeyword => //not sure if det need to be in both
...
export const makeSetExp = (varname: VarRef, value: CExp): SetExp =>
    ({tag: "SetExp", var: varname, val: value})
// L3
